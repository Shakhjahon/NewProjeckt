package com.example.newprojeckt.presentation.FoodDeteils
...
import com.example.newprojeckt.databinding.FragmentFoodDeteilsBinding
...
class FoodDeteilsFragment : Fragment() {
    ...
    private val binding by lazy {
        FragmentFoodDeteilsBinding.inflate(layoutInflater)
    }

    private val sharedpref: UserEnteredSharedpref by lazy {
    ...
    private fun setUpClickLisners(foodModel: FoodModel) {
        binding.apply {
            ...
            addToCart.setOnClickListener {
                ...
                Snackbar.make(
                    requireView(), "Added to cart sucssfully", Snackbar.LENGTH_SHORT
                ).show()
